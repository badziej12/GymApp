...
export default function SignUp() {
  ...
  const handleRegister = async () => {
    if (!emailRef.current || !passwordRef.current || !username.current) {
        ...
        <View style={{paddingTop: hp(20), paddingHorizontal: wp(5)}} className="flex-1 gap-12">
          ...
          <View className="gap-4">
            ...
            <TouchableOpacity onPress={handleRegister} style={{height: hp(6.5)}} className="bg-indigo-500 rounded-xl justify-center">
              <Text style={{fontSize: hp(2.7)}} className="text-white font-bold tracking-wider text-center">Sign Up</Text>
            </TouchableOpacity>
            ...
            <View className="flex-row justify-center">
              ...
              <Pressable onPress={() => router.push('/signIn')}>
                <Text style={{fontSize: hp(1.8)}} className="font-bold text-indigo-500 ml-1">Sign in</Text>
              </Pressable>
            </View>
          </View>
        </View>
